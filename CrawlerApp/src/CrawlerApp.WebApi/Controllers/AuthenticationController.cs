...
namespace CrawlerApp.WebApi.Controllers
{
    public class AuthenticationController : ApiControllerBase
    {
        ...
        private const string REDIRECT_URI = "https://localhost:7015/api/Authentication/GoogleSignIn";

        public AuthenticationController(IAuthenticationService authenticationService, IOptions<GoogleSettings> googleSettings)
        {
